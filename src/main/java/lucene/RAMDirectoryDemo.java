...
public class RAMDirectoryDemo {  
    public static void main(String[] args) throws IOException {  
        ...
        StandardAnalyzer  simpleAnalyzer = new StandardAnalyzer();
        IndexWriterConfig conf = new IndexWriterConfig(simpleAnalyzer);
        ...
        */  
        doc.add(new StringField("name", "Cheng hui", Field.Store.YES));  
        doc.add(new StringField("sex", "男 的", Field.Store.YES));  
        doc.add(new StringField("dosometing", "I am learning lucene ",Field.Store.YES));  
        doc.add(new StringField("dosometing", new BytesRef("I am learning lucene "),Field.Store.YES));  
        ...
        Query query = new TermQuery(new Term("name", "Cheng hui"));   
